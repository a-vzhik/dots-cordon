...
func (x *SimulateMoveRequest) Reset() {
	*x = SimulateMoveRequest{}
	mi := &file_game_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SimulateMoveRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimulateMoveRequest) ProtoMessage() {}

func (x *SimulateMoveRequest) ProtoReflect() protoreflect.Message {
	mi := &file_game_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use SimulateMoveRequest.ProtoReflect.Descriptor instead.
func (*SimulateMoveRequest) Descriptor() ([]byte, []int) {
	return file_game_proto_rawDescGZIP(), []int{0}
}

func (x *SimulateMoveRequest) GetGame() *GameState {
	if x != nil {
		return x.Game
	}
	return nil
...
func (x *SimulateMoveRequest) GetPosition() *Coordinate {
	if x != nil {
		return x.Position
	}
	return nil
...
const file_game_proto_rawDesc = "" +
	...
	"\x1dTERMINATION_REASON_TURN_LIMIT\x10\x022\xef\x03\n" +
	"\vGameService\x12Q\n" +
	"\n" +
	...
	"\fSimulateMove\x12\".dotscordon.v1.SimulateMoveRequest\x1a\x1f.dotscordon.v1.MakeMoveResponseB?Z=github.com/a-vzhik/dots-cordon/api/dotscordon/v1;dotscordonv1b\x06proto3"
...
var file_game_proto_goTypes = []any{
	...
	(*SimulateMoveRequest)(nil), // 2: dotscordon.v1.SimulateMoveRequest
	(*CreateGameRequest)(nil),   // 3: dotscordon.v1.CreateGameRequest
	(*CreateGameResponse)(nil),  // 4: dotscordon.v1.CreateGameResponse
	(*GetGameRequest)(nil),      // 5: dotscordon.v1.GetGameRequest
	(*GetGameResponse)(nil),     // 6: dotscordon.v1.GetGameResponse
	(*MakeMoveRequest)(nil),     // 7: dotscordon.v1.MakeMoveRequest
	(*MakeMoveResponse)(nil),    // 8: dotscordon.v1.MakeMoveResponse
	(*ResetGameRequest)(nil),    // 9: dotscordon.v1.ResetGameRequest
	(*ResetGameResponse)(nil),   // 10: dotscordon.v1.ResetGameResponse
	(*DeleteGameRequest)(nil),   // 11: dotscordon.v1.DeleteGameRequest
	(*DeleteGameResponse)(nil),  // 12: dotscordon.v1.DeleteGameResponse
	(*GameState)(nil),           // 13: dotscordon.v1.GameState
	(*Board)(nil),               // 14: dotscordon.v1.Board
	(*MoveResult)(nil),          // 15: dotscordon.v1.MoveResult
	(*Cordon)(nil),              // 16: dotscordon.v1.Cordon
	(*Coordinate)(nil),          // 17: dotscordon.v1.Coordinate
}
var file_game_proto_depIdxs = []int32{
	13, // 0: dotscordon.v1.SimulateMoveRequest.game:type_name -> dotscordon.v1.GameState
	17, // 1: dotscordon.v1.SimulateMoveRequest.position:type_name -> dotscordon.v1.Coordinate
	13, // 2: dotscordon.v1.CreateGameResponse.game:type_name -> dotscordon.v1.GameState
	13, // 3: dotscordon.v1.GetGameResponse.game:type_name -> dotscordon.v1.GameState
	17, // 4: dotscordon.v1.MakeMoveRequest.position:type_name -> dotscordon.v1.Coordinate
	13, // 5: dotscordon.v1.MakeMoveResponse.game:type_name -> dotscordon.v1.GameState
	15, // 6: dotscordon.v1.MakeMoveResponse.result:type_name -> dotscordon.v1.MoveResult
	13, // 7: dotscordon.v1.ResetGameResponse.game:type_name -> dotscordon.v1.GameState
	14, // 8: dotscordon.v1.GameState.board:type_name -> dotscordon.v1.Board
	1,  // 9: dotscordon.v1.GameState.termination_reason:type_name -> dotscordon.v1.TerminationReason
	17, // 10: dotscordon.v1.MoveResult.killed_cells:type_name -> dotscordon.v1.Coordinate
	16, // 11: dotscordon.v1.MoveResult.cordons:type_name -> dotscordon.v1.Cordon
	17, // 12: dotscordon.v1.Cordon.positions:type_name -> dotscordon.v1.Coordinate
	3,  // 13: dotscordon.v1.GameService.CreateGame:input_type -> dotscordon.v1.CreateGameRequest
	5,  // 14: dotscordon.v1.GameService.GetGame:input_type -> dotscordon.v1.GetGameRequest
	7,  // 15: dotscordon.v1.GameService.MakeMove:input_type -> dotscordon.v1.MakeMoveRequest
	9,  // 16: dotscordon.v1.GameService.ResetGame:input_type -> dotscordon.v1.ResetGameRequest
	11, // 17: dotscordon.v1.GameService.DeleteGame:input_type -> dotscordon.v1.DeleteGameRequest
	2,  // 18: dotscordon.v1.GameService.SimulateMove:input_type -> dotscordon.v1.SimulateMoveRequest
	4,  // 19: dotscordon.v1.GameService.CreateGame:output_type -> dotscordon.v1.CreateGameResponse
	6,  // 20: dotscordon.v1.GameService.GetGame:output_type -> dotscordon.v1.GetGameResponse
	8,  // 21: dotscordon.v1.GameService.MakeMove:output_type -> dotscordon.v1.MakeMoveResponse
	10, // 22: dotscordon.v1.GameService.ResetGame:output_type -> dotscordon.v1.ResetGameResponse
	12, // 23: dotscordon.v1.GameService.DeleteGame:output_type -> dotscordon.v1.DeleteGameResponse
	8,  // 24: dotscordon.v1.GameService.SimulateMove:output_type -> dotscordon.v1.MakeMoveResponse
