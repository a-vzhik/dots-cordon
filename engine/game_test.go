...
func TestMove_CapturesDotInDiamond(t *testing.T) {
	...
	assert.Equal(t, &MoveResult{
		ScoredPoints: 1,
		Cordons: [][]Dot{{
			{Coord: Coord{Row: 1, Col: 2}, Owned: true, Owner: 0},
			{Coord: Coord{Row: 2, Col: 3}, Owned: true, Owner: 0},
			{Coord: Coord{Row: 3, Col: 2}, Owned: true, Owner: 0},
			{Coord: Coord{Row: 2, Col: 1}, Owned: true, Owner: 0},
			{Coord: Coord{Row: 1, Col: 2}, Owned: true, Owner: 0},
		}},
		KilledDots: []Dot{{
	...
	moves := []move{
		...
		{row: 2, col: 6},
		{
			...
			want: &MoveResult{
				...
				Cordons: [][]Dot{{
					...
					{Coord: Coord{Row: 1, Col: 2}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 2, Col: 2}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 3, Col: 1}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 2, Col: 0}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 1, Col: 0}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 0, Col: 1}, Owned: true, Owner: 0},
				}},
				KilledDots: []Dot{
					{Coord: Coord{Row: 1, Col: 1}, Owned: true, Owner: 1},
					{Coord: Coord{Row: 2, Col: 1}, Owned: true, Owner: 1},
				},
			},
		},
		{row: 4, col: 0},
		...
		{row: 6, col: 3},
		{
			...
			want: &MoveResult{
				ScoredPoints: 2,
				Cordons: [][]Dot{{
					{Coord: Coord{Row: 3, Col: 5}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 4, Col: 6}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 5, Col: 6}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 6, Col: 5}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 5, Col: 4}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 4, Col: 4}, Owned: true, Owner: 0},
					{Coord: Coord{Row: 3, Col: 5}, Owned: true, Owner: 0},
				}},
				KilledDots: []Dot{
					{Coord: Coord{Row: 4, Col: 5}, Owned: true, Owner: 1},
					{Coord: Coord{Row: 5, Col: 5}, Owned: true, Owner: 1},
				},
			},
		},
	}
